...
// 		$.ajax({
// 			url:
// 				'https://www.dubaihousing-ae.com/pages/countryCode/' +
// 				escape(value) +
// 				'/',
// 			dataType: 'json',
// 			success: function (result) {
...
// 	$.ajax({
// 		url:
// 			'https://www.dubaihousing-ae.com/pages/StoreIpInDataBase/' + value + '/',
// 		contentType: 'html',
// 		cache: !1,
// 		dataType: 'json',
...
// if (segments[3] === 'project' && segments[3] === 'area-guide') {
// } else {
// 	$(function () {
// 		$('#search_prop')
// 			.autocomplete({
...
// 				select: function (a, b) {
// 					return (
// 						$('#search_prop').val(b.item.label),
// 						$('#project-id').val(b.item.value),
// 						!1
// 					);
// 				},
// 			})
